var customWeb3 = customElements.define('custom-web3', class CustomWeb3 extends HTMLElement {
  ...
  async _init() {
    ...
    if (!this.isSupported || !globalThis.web3) await import('./web3.min-2ef25b38.js');
